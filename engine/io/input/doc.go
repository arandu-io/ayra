...
of a user interface and is exposed by [github.com/arandu-io/ayra/engine/app.FrameEvent]
received from windows.

The [Router] is used by [github.com/arandu-io/ayra/engine/app.Window] to track window state and route
