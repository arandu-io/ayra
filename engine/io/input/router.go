...
// [github.com/arandu-io/ayra/engine/io/key.Filter] with a non-empty Name, receive them.
// [github.com/arandu-io/ayra/engine/app.Window] uses SystemEvent for keys reserved for focus
